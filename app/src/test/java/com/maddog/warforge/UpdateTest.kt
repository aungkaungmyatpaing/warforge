...
import com.maddog.warforge.update.UpdateState
import com.maddog.warforge.update.decideUpdate
...
class UpdateTest {
    ...
    private fun manifest(latest: Int, min: Int = 0) = UpdateManifest(
        ...
        notes = "",
        url = "https://play.google.com/store/apps/details?id=com.maddog.warforge",
    )
    ...
    fun `a full manifest parses`() {
        ...
        assertEquals("com.maddog.warforge", m.playPackage)
    }
