...
import com.maddog.warforge.BuildConfig
import androidx.appcompat.app.AppCompatActivity
import com.maddog.warforge.ads.AdsManager
import com.maddog.warforge.ads.ConsentManager
...
abstract class AdHostActivity : AppCompatActivity() {
    ...
    /**
     * Exposed so a screen can offer the "Privacy options" entry point. Google requires
     * one to stay reachable for as long as the app is installed, wherever a consent form
     * was shown in the first place.
     */
    protected lateinit var consent: ConsentManager
        private set
